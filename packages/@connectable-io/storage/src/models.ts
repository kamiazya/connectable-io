 ...
 * @example
 * ```ts
 * import '@connectable-io/storage-plugin-file';
...
export interface StorageStatic extends Registry<Storage> {
   ...
   * @throws {import('@connectable-io/core').PluginNotLoadedError} if the scheme is not loaded.
   * @example
   * ```ts
...
export class StorageRegistry extends URLProtocolBasedRegistry<Storage> implements StorageStatic {
  constructor() {
    super('Storage')
  }
  /**
