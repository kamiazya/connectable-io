 ...
 */
export interface TmpStorageAdapterOptions extends FileHandleOpenOptions {
  /**
 ...
 */
export class TmpStorageAdapter implements Storage {
  ...
  constructor({
    ...
    mode = 0o666,
  }: TmpStorageAdapterOptions = {}) {
    this.urlSchema = urlSchema
    this.baseDir = isAbsolute(baseDir) ? baseDir : resolve(tmpdir(), baseDir)
    this.read = read
    this.write = write
    this.create = create
    this.mode = mode
